 ...
 * 科技锁注册工具类
 */
public class GetRoomUtil {
	private static GetRoomUtil util;
	
	private GetRoomUtil(){}
	
	public static GetRoomUtil getInstance(){
		if( util == null ){
			util = new GetRoomUtil();
		}
		return util;
	}
	...
	public String getRoom(){
		...
		String url = MessageFormat
				.format("https://api.sciener.cn/v1/room/list?client_id={0}&access_token={1}&date={2}",
	...
	public static void main(String[] args) {
		...
		GetRoomUtil.getInstance().getRoom();
	}
}
