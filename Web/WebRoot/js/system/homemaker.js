...
$(function(){
	...
	$('#test').datagrid({
		...
		columns:[[
			{field:'hm_name',title:'管家名称',width:200,sortable:true},
...
var HomeMaker = Backbone.Model.extend({
	validate: function(attrs, options) {
	    if( $.trim(attrs.hm_name) == "" ){ return "管家名字不能为空..."; }
...
function save(index){
    ...
    $.ajax({
            ...
            url:'saveHomeMaker',
            data: { homemaker: JSON.stringify(datas)},//要传递的数据
            success: function(resp){
