...
<html>
	...
	<body>
		...
		<script type="text/x-handlebars-template" id="tmp_save">
    			...
    			<input type="text" name="bankName" id="bankName" placeholder="请输入银行开户行" value="{{getValue bankName}}"><br>
				
				<label for="bankNum">银行账号</label>
    			<input type="text" name="bankNum" id="bankNum" placeholder="请输入银行账号" value="{{getValue bankNum}}"><br>

				<label for="bankPerson">开户人</label>
    			<input type="text" name="bankPerson" id="bankPerson" placeholder="请输入开户人" value="{{getValue bankPerson}}"><br>
		...
		<script type="text/javascript" src="<%=basePath%>js/system/bankinfo.js"></script>
	</body>
</html>
